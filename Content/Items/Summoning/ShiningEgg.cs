...
namespace voxelmod.Content.Items.Summoning
{
	...
	public class ShiningEgg : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return player.ZoneSkyHeight && !NPC.AnyNPCs(ModContent.NPCType<Corvus>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<Corvus>();
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<Items.Materials.BlackFeather>(6)
